...
export default function Frame() {
  return (
    <div className="relative size-full">
      ...
      <div className="absolute h-[75px] left-[39px] top-[49px] w-[325px]" data-name="corydoratitle">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-full left-[-150.15%] max-w-none top-0 w-[511.08%]" src={imgCorydoratitle} />
        </div>
      </div>
    </div>
  );
